...
func (repo *Repository[A]) InsertMany(models []A) (*mongo.InsertManyResult, error) {
...
func (repo *Repository[A]) InsertManyWithDatabase(db *database.GoodmDatabase, models []A) (*mongo.InsertManyResult, error) {
